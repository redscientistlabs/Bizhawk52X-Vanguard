...
//				Util.DebugWriteLine($"  Selecting display size {lastComputedSize}");
		...
		private void OpenRom()
		{
			var result = this.ShowFileOpenDialog(
				...
				initDir: Config.PathEntries.LastRomPath); //Config.PathEntries.RomAbsolutePath(Emulator.SystemId));
		...
		//RTC_Hijack : Make loading public
		public void LoadConfigFile(string iniPath)
		{
