...
#pragma warning restore CA2211
		...
		{
			return allowInput == AllowInput.None || (allowInput == AllowInput.OnlyController && inputFocus != ClientInputFocus.Pad) || RTCV.BizhawkVanguard.Hooks.IsAllowedBackgroundInputForm(); //RTC_Hijack : Polling RTC focus for Background input
		}
